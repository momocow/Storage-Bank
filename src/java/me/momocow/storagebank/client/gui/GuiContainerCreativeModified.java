...
/**
 * A copy from vanilla {@linkplain net.minecraft.client.gui.inventory.GuiContainerCreative GuiContainerCreative} to modify the {@linkplain net.minecraft.client.gui.inventory.GuiContainerCreative.ContainerCreative GuiContainerCreative.ContainerCreative}
 * @author MomoCow
 */
public class GuiContainerCreativeModified extends InventoryEffectRenderer
{
    ...
    public GuiContainerCreativeModified(EntityPlayer player)
    {
        super(new GuiContainerCreativeModified.ContainerCreative(player));
    ...
    protected void handleMouseClick(Slot slotIn, int slotId, int mouseButton, ClickType type)
    {
        ...
        else if (selectedTabIndex == CreativeTabs.INVENTORY.getTabIndex())
        {
            ...
            {
                this.mc.thePlayer.inventoryContainer.slotClick(slotIn == null ? slotId : ((GuiContainerCreativeModified.CreativeSlot)slotIn).slot.slotNumber, mouseButton, type, this.mc.thePlayer);
    ...
    {
    	GuiContainerCreativeModified.ContainerCreative guicontainercreative$containercreative = (GuiContainerCreativeModified.ContainerCreative)this.inventorySlots;
    ...
    private void updateFilteredItems(GuiContainerCreativeModified.ContainerCreative guicontainercreative$containercreative)
    {
    ...
    private boolean needsScrollBars()
    {
        ...
        return selectedTabIndex != CreativeTabs.INVENTORY.getTabIndex() && CreativeTabs.CREATIVE_TAB_ARRAY[selectedTabIndex].shouldHidePlayerInventory() && ((GuiContainerCreativeModified.ContainerCreative)this.inventorySlots).canScroll();
    }
    ...
    private void setCurrentCreativeTab(CreativeTabs tab)
    {
        ...
        if (tab == CreativeTabs.INVENTORY)
        {
            ...
            {
                Slot slot = new GuiContainerCreativeModified.CreativeSlot((Slot)container.inventorySlots.get(j), j);
    ...
    public void handleMouseInput() throws IOException
    {
        ...
        {
            int j = (((GuiContainerCreativeModified.ContainerCreative)this.inventorySlots).itemList.size() + 9 - 1) / 9 - 5;
            ...
            ((GuiContainerCreativeModified.ContainerCreative)this.inventorySlots).scrollTo(this.currentScroll);
        }
    }
    ...
    static class ContainerCreative extends Container
        {
            ...
            public ContainerCreative(EntityPlayer player)
            {
                ...
                for (int i = 0; i < 5; ++i)
                {
                    for (int j = 0; j < 9; ++j)
                    {
                        this.addSlotToContainer(new Slot(GuiContainerCreativeModified.basicInventory, i * 9 + j, 9 + j * 18, 18 + i * 18));
                    }
                }
            ...
            public void scrollTo(float p_148329_1_)
            {
                ...
                for (int k = 0; k < 5; ++k)
                {
                    for (int l = 0; l < 9; ++l)
                    {
                        ...
                        {
                        	GuiContainerCreativeModified.basicInventory.setInventorySlotContents(l + k * 9, (ItemStack)this.itemList.get(i1));
                        }
                        else
                        {
                        	GuiContainerCreativeModified.basicInventory.setInventorySlotContents(l + k * 9, (ItemStack)null);
                        }
                    }
                }
            }
            ...
            public ItemStack transferStackInSlot(EntityPlayer playerIn, int index)
            {
                if (index >= this.inventorySlots.size() - 9 && index < this.inventorySlots.size())
                {
                    ...
                    {
                    	//de-register the IDCard before it is set to null
